...
async def predict(request: PredictionRequest):
    """
    Real-time churn inference.
    Uses run_in_threadpool so CPU-bound LightGBM inference doesn't block
    the async event loop — allows FastAPI to handle concurrent requests.
    """
